...
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=4EA1FF&height=200&section=header&text=Ahmad%20Hijazi&fontSize=60&fontColor=ffffff&animation=fadeIn&fontAlignY=35" alt="Ahmad Hijazi Banner"/>

  <!-- Animated Typing Text -->
  [![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=28&duration=4000&pause=1000&color=4EA1FF&center=true&vCenter=true&width=600&height=50&lines=Full-Stack+%26+Mobile+Developer;Flutter+%7C+PHP+%7C+Node.js+%7C+React;Problem+Solver+%26+Clean+Code+Advocate;Turning+Ideas+Into+Digital+Reality)](https://git.io/typing-svg)
...
I’m **Ahmad Hijazi**, a Full-Stack & Mobile Developer deeply passionate about crafting scalable, user-friendly applications. I build with **Flutter**, **React**, **Node.js**, **PHP**, and more — always aiming for clean architecture, maintainability, and performance.
...
- **Client Portal Mobile App** — A Flutter app with a PHP backend that integrates with Zoho APIs to manage invoices, support tickets, and projects in real-time.  
- **Restaurant Ordering System** — Web application for managing food orders and reservations, built with PHP and MySQL.  
- **E-Commerce Platform** — React + Node.js web store with product catalog, shopping cart, and secure Stripe payment.  
- **Real-Time Social App** — Flutter + Firebase app for social interactions, posts, and live chat.

---

## 💼 Experience

| Role | Company | Period | Technologies |
|---|---|---|---|
| Flutter Mobile Development Intern | Eventus-M.E | Jul 2025 – Oct 2025 | Flutter · PHP · MySQL |  
| Full-Stack Intern | Eventus-M.E | Jun 2023 – Aug 2023 | PHP · MySQL · JavaScript |
